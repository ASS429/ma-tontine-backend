...
/* -----------------------
   ...
   - force=0 → preview : renvoie si possible ou non
...
router.post("/run/:tontineId", async (req, res) => {
  ...
  try {
    ...
    // 4️⃣ Vérifier pas déjà tiré pour ce cycle
    ...
    // 5️⃣ Vérifier si tous les membres ont déjà gagné
    ...
    // 6️⃣ Exécution réelle du tirage
    const r = await pool.query(
    ...
    // 8️⃣ Nouveau cycle ou fin de tontine
